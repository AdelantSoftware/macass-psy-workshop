  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden safe-inset">
      ...
      <AnimatePresence>
        {!exiting && (
          <motion.div
            className="relative z-10 flex flex-col items-center justify-center min-h-[100dvh] layout-padding gap-12"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.4 }}
          >
            {/* Icon — micro-spacing: gap-3 to title */}
                        <motion.div
                        ...
                        <motion.h1
                          className="font-display text-center text-[2.5rem] sm:text-5xl md:text-6xl font-bold leading-tight max-w-sm sm:max-w-md mt-8"
                        ...
                        {/* Body text — gap-4 below title, gap-10 to button */}
                        <motion.p
                          className="font-body text-center text-[0.95rem] sm:text-lg text-[#c8c0d8] leading-relaxed max-w-xs sm:max-w-sm mt-4"
                        ...
                        {/* Button — macro-spacing: gap-10 from text */}
                        <motion.button
                          onClick={handleStart}
                          className="font-display text-xl sm:text-2xl font-bold text-white rounded-full cursor-pointer min-h-[56px] px-12 py-5 w-full max-w-[280px] mt-10"
                          style={{
